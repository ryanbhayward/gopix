...
(c) edge node [above]      {2} (e)
(d) edge node [above,left] {5} (t)
(e) edge node [above,left] {1} (a) 
    edge node [above,left] {1} (d) 
    edge node [above,left] {1} (t)
;
\end{tikzpicture}\]
\vfill \ 
